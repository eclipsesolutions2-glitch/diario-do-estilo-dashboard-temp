...
interface TableListHistoryArticleProps {
	data: HistorySentArticleItem[];
}

export function TableListHistoryArticle({
	data,
}: TableListHistoryArticleProps) {
	...
	const emptyLabel = "Nenhum artigos encontrado";
